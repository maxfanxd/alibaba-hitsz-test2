...
# echo "[2/6] 运行：非 RAG 推理（采样解码，默认） ..."
# python infer_lora_qwen.py \
#   --input_path datasets/CDrugRed-A-v1/CDrugRed_test-B.jsonl \
#   --model_path models/qwen2.5-7b-instruct \
#   --lora_path checkpoints/qwen2.5-7b-instruct-lora-16EP \
#   --candidate_path datasets/CDrugRed-A-v1/候选药物列表.json \
#   --output_dir output/10_22-16epwithoutrag_2 \
#   --max_items 20 \
#   --max_new_tokens 256 \
#   --min_new_tokens 8 \
#   --num_beams 1 \
...
python infer_lora_qwen.py \
  ...
  --embed_device cuda \
  --rag_top_k 1 --rag_min_cosine 0.40 \
  --max_items 20 \
  --output_dir output/10_22-16epwithrag_1 \
  --rag_log

# echo "[4/6] 运行：RAG 向量检索增强推理（采样解码） ..."
# # max_items 限制的是“每条样本输出药物数量”，不影响样本总数
# python infer_lora_qwen.py \
#   --input_path datasets/CDrugRed-A-v1/CDrugRed_test-B.jsonl \
#   --model_path models/qwen2.5-7b-instruct \
...
#   --temperature 0.7 \
#   --top_p 0.9 \
#   --output_dir output/10_22-16epwithrag_2 \
#   --rag_log
